...
import { createChannelStock, deleteChannelStock, importChannelStock } from "./actions";
    ...
    <div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
              ...
              <Table headers={["Period", "Holder", "Product", "Cases", "Source", ""]} align={["left", "left", "left", "right", "left", "left"]}>
                {stocks.map((s) => (
                  <tr key={s.id}>
                    ...
                    <Td>{s.source === "IMPORT" ? <Badge tone="blue">Import</Badge> : <Badge>Manual</Badge>}</Td>
                    <Td>
        ...
        <div className="space-y-6">
          <Card title="Import stock report (CSV)">
            <form action={importChannelStock} className="space-y-3">
              ...
              <div className="text-xs leading-relaxed text-slate/80">
                ...
                <p className="mt-1">
                  ...
                  Karma / iDig exports: send me a sample file and I&apos;ll add a one-click parser for their exact format.
                </p>
              </div>
            </form>
          </Card>
